...
<div class="auth-page">
    ...
    <div class="auth-card">
        ...
        <div class="auth-subtitle">Masukkan username/email dan kata sandi Anda.</div>
        ...
        <form method="POST" action="{{ route('login.store') }}">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="login" name="login" class="form-control" placeholder="username atau email"
            ...
            <div class="d-flex align-center justify-between mb-16" style="margin-bottom: 22px;">
                <label class="form-check">
                    <input type="checkbox" name="remember" class="form-check-input" value="1" @checked(old('remember')) />
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        @endif
        @if (session('error'))
            Toast.error('Login Gagal', @json(session('error')));
        @endif
        @if (session('success'))
